<?php
  ...
  $token = base64_encode(md5('transaksi_neracasaldo'.$_SESSION['keu_admin_id'].$_SESSION['keu_admin_name']));
  if(!isset($_SESSION)){ // login 
    echo 'user has been logout';
  }else{ // logout
    if(isset($_GET['token']) and $token===$_GET['token']){
          ob_start(); // digunakan untuk convert php ke html
          $sql = "SELECT keu_jurnal.rek,keu_rekening.kode as koderek,keu_rekening.nama as nrek 
                  FROM keu_jurnal 
                  ...
                  AND keu_transaksi.tanggal >= '2015-03-1' AND 
                  keu_transaksi.tanggal <= '2015-03-31' 
                  GROUP BY keu_jurnal.rek 
                  ORDER BY keu_rekening.kode";
          ...
          $out='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            <html xmlns="http://www.w3.org/1999/xhtml">
              <head>
                ...
                <title>SIADU::Keu - Neraca Saldo</title>
              </head>
