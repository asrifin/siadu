...
if(!$detail){
echo'<tr><td colspan="7"><h4>Laporan Pembelian, Dari '.$tglmulai.', Sampai '.$tglakhir.'</h4></td></tr>';
echo '
<tr class="border">
<td>No</td>
<td>No.Invoice</td>
...
echo'<tr><td colspan="8"><h4>Laporan Pembelian, Dari '.$tglmulai.', Sampai '.$tglakhir.'</h4></td></tr>';
echo '
<tr class="border">
<td>No</td>
<td>No.Invoice</td>
